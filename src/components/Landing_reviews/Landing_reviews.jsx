...
export default function Landing_reviews({img, review, name, location}) {
  return (
    <div className="w-[700px] h-[500px] rounded-[20px] shadow-2xl shadow-black/50 overflow-hidden flex flex-col">
      ...
      <div div className="w-[full h-[30%] bg-gradient-to-r from-indigo-800 via-purple-700 to-pink-900 flex flex-col ">
