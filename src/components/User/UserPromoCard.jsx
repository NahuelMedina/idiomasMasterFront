...
export default function UserPromoCard({
  ...
  return (
    <div className="w-[98%] h-[500px] bg-white flex items-center justify-center">
    <div className="w-[95%] h-[90%] border-[1px] border-gray-70 bg-white cursor-pointer rounded-[10px] shadow-md shadow-black/10 overflow-hidden hover:scale-105 transition-all duration-300 hover:shadow-black/20 relative group:">
      ...
      <div className="absolute bg-transparent w-full h-full opacity-0 hover:opacity-100 transition-opacity duration-300 hover:bg-white">
        <div className="w-full h-[70px] flex flex-row items-center justify-start">
          ...
          <h2 className="text-black text-[20px]">{level}</h2>
        </div>
        <div className="w-full h-[70px] flex flex-row items-center justify-start">
          <GrSchedule className="text-[40px] text-black m-[30px] "/>
          <h2 className="text-black text-[20px]">{schedule}</h2>
        </div>
